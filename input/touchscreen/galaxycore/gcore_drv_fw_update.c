...
#if defined(CONFIG_PROJ_E93_FROG)
#include "firmware/e93_frog.h"
#elif defined(CONFIG_PROJ_E97_FROG)
#include "firmware/e97_frog.h"
#else
...
void gcore_request_firmware_update_work(struct work_struct *work)
{
	...
	GTP_DEBUG("fw bin ver:%x %x %x %x", gdev_fwu->fw_ver[1], gdev_fwu->fw_ver[0], \
										gdev_fwu->fw_ver[3], gdev_fwu->fw_ver[2]);
