...
static int JD_GetRawData_Frame_Number;
static int JD_GetDiffData_Frame_Number;
static int JD_SkipRawData_Frame_Number;
static int JD_SkipDiffData_Frame_Number;
...
char *jd_global_variable_name[] = {
	"GetRawDataFrameNumber",
	"GetDiffDataFrameNumber",
	"SkipRawDataFrameNumber",
	"SkipDiffDataFrameNumber",
};

enum JD_GLOBAL_VARIABLE_ITEM {
	JD_GLOBAL_GETRAWDATA_FRAME_NUMBER = 0,
	JD_GLOBAL_GETDIFFDATA_FRAME_NUMBER,
	JD_GLOBAL_SKIPRAWDATA_FRAME_NUMBER,
	JD_GLOBAL_SKIPDIFFDATA_FRAME_NUMBER,
	JD_GLOBAL_VARIABLE_END,
};
...
enum JD_SORTING_ACTION_ITEM {
	...
	JD_SORTING_NORMALACTIVE_TOUCH_CHECK,
	JD_SORTING_ITEM_END,
};
...
enum JD_SORTING_ERROR_STATUS {
	...
	JD_SORTING_NORMALACTIVE_TOUCH_CHECK_ERR = 1 << 12,
};
