...
// revo common setting
    ...
    ||defined(PRJ_FEATURE_H_BOARD_HAVE_PLS_TP)
#define TLSC_TPD_PROXIMITY 
#endif


#ifdef SCREEN_PHY_WIDTH
#define SCREEN_MAX_X SCREEN_PHY_WIDTH
#else
#define SCREEN_MAX_X    480
#endif

#ifdef SCREEN_PHY_HIGHT
#define SCREEN_MAX_Y SCREEN_PHY_HIGHT
#else
...
struct tlsc6x_data {
	...
	struct work_struct	report_event_work;      /*@zdk add*/
	struct workqueue_struct	*report_workqueue;  /*@zkd add*/
	int irq_gpio_number;
