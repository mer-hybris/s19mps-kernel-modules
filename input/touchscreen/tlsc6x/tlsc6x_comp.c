...
#if defined(CONFIG_PROJ_C64_YIBOTONG)
#include "firmware/c64_yibotong/tlsc6x_boot.h"
#elif defined(CONFIG_PROJ_E96_YIBOTONG)
#include "firmware/e96_yibotong/tlsc6x_boot.h"
#else
...
//qzhu note:e96 yibotong boot v6-v8 is not change,so not need to update boot
#if defined(CONFIG_PROJ_E96_YIBOTONG)
  return 0;
#endif
