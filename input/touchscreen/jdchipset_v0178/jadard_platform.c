...
void jadard_int_enable(bool enable)
{
	...
	irqnum = pjadard_ts_data->client->irq;
...
{
	JD_I("Jadard kmodule common touch panel driver init\n");
...
#else
extern int jadard_jd9366t_init(void);
extern void jadard_jd9366t_exit(void);
