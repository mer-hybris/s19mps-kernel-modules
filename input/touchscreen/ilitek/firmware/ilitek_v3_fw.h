...
#if defined(CONFIG_PROJ_L90_TENGZHI)
	#include "fw_l90.ili"
#elif defined(CONFIG_PROJ_E93_FROG)
	#include "fw_e93_frog.ili"
#elif defined(CONFIG_PROJ_E93_YIBOTONG)
	#include "fw_e93_yibotong.ili"
#else
