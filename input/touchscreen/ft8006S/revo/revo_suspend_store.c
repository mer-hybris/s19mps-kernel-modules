...
extern int glb_focaltech_ft8006S_resume(void) ;
extern int glb_focaltech_ft8006S_suspend(void) ;


#define  REVO_TS_SUSPEND_FUNC            glb_focaltech_ft8006S_resume()
#define  REVO_TS_RESUME_FUNC             glb_focaltech_ft8006S_suspend()
...
int glb_focaltech_ft8006s_tp_sysfs_init(struct i2c_client *client){
