...
ex:  (glb)+(focaltech/ft8006S)+(resume|suspend)   = 
       + glb_focaltech_ft8006S_resume  
       ` glb_focaltech_ft8006S_suspend 
*/

int glb_focaltech_ft8006S_resume(void)
{
...
int glb_focaltech_ft8006S_suspend(void)
{
	 struct fts_ts_data * cts_data = REVO_GET_TS_DATA ;
	 if(cts_data == NULL )
	 {
...
#endif  /* End : REVO_SUSPEND_INTERFACES */