...
#if defined(REVO_CHIP_TYPE_FT8009)
#define FTS_CHIP_TYPE_MAPPING {{0x17, 0x80, 0x09, 0x80, 0x09, 0x80, 0xA9, 0x00, 0x00}}
#elif defined (REVO_CHIP_TYPE_FT8006AN)
#define FTS_CHIP_TYPE_MAPPING {{0x1E, 0x86, 0x42, 0x86, 0x42, 0x86, 0xC2, 0x00, 0x00}, {0x22, 0xF0, 0xC6, 0xF0, 0xC6, 0xF0, 0xD6, 0x00, 0x00}}
#else
#define FTS_CHIP_TYPE_MAPPING {{0x19, 0x86, 0x32, 0x86, 0x32, 0x86, 0xC2, 0x00, 0x00},{0x19, 0x86, 0x42, 0x86, 0x32, 0x86, 0xC2, 0x00, 0x00},{0x22, 0xF0, 0xC6, 0xF0, 0xC6, 0xF0, 0xD6, 0x00, 0x00}}
#endif
