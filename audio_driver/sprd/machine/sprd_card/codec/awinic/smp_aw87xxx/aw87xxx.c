...
int (*func_aw87xxx_set_profile)(int channel, char *profile);
int (*func_aw87xxx_add_codec_controls)(void *codec);
EXPORT_SYMBOL(func_aw87xxx_set_profile);
EXPORT_SYMBOL(func_aw87xxx_add_codec_controls);
...
static void aw87xxx_fw_load(const struct firmware *fw, void *context)
{
	...
	func_aw87xxx_set_profile = aw87xxx_set_profile;
	func_aw87xxx_add_codec_controls = aw87xxx_add_codec_controls;
